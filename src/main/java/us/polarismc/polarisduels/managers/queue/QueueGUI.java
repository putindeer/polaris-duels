...
public class QueueGUI extends FastInv {
    ...
    public QueueGUI(Player player, QueueType type, Main plugin) {
        ...
        // SMP
        setItem(10, plugin.utils.ib(Material.ENDER_PEARL).name("&#ff00d1&lSMP")
        ...
        // AXE
        setItem(11, plugin.utils.ib(Material.DIAMOND_AXE).name("&#9300ff&lAxe")
        ...
        // NETHERITEPOT
        setItem(12, plugin.utils.ib(Material.NETHERITE_HELMET).name("&#808080&lNetheritePot")
        ...
        // UHC
        setItem(13, plugin.utils.ib(Material.GOLDEN_APPLE).name("&#d1bb00&lUHC")
        ...
        // DIAMONDPOT
        setItem(14, plugin.utils.ib(Material.SPLASH_POTION).potionType(PotionType.HEALING).customName("&#ff0000&lDiamondPot")
        ...
        // SWORD
        setItem(15, plugin.utils.ib(Material.DIAMOND_SWORD).name("&#00fff3&lSword")
